  ...
  return (
    <div className="text-[#ffffff] bg-[#000000]  px-2   md:px-0 pt-6 md:pt-10 flex flex-col lg:flex-row items-center space-x-0 lg:space-x-24 justify-between ">
      <div className="w-full lg:w-[50%]">
        <p className="text-xl md:text-4xl lg:text-4xl xl:text-5xl font-bold md:leading-snug">
      ...
      <div className="w-full lg:w-[50%]">
        ...
        <p className="text-[#ffffff] text-sm md:text-md md:text-lg font-normal pt-4 md:pt-8 leading-snug">
