  ...
  return (
    <div className="text-[#ffffff] bg-[#000000] px-2 md:px-0 pt-6 md:pt-10  flex flex-col lg:flex-row  items-center space-x-0 lg:space-x-24 justify-between ">
      ...
      <div className="w-full lg:w-[50%]">
        ...
        <p className="text-[#ffffff] text-sm md:text-lg lg:text-md xl:text-lg font-normal pt-4 md:pt-8 leading-snug">
     Lorem ipsum dolor sit, amet consectetur adipisicing elit. Sed impedit incidunt error ex in voluptatem pariatur porro, voluptate nihil assumenda aliquid perferendis mollitia fugiat aut consequatur amet exercitationem corporis rem. Placeat dolorum officiis nam aliquid, non consectetur quis voluptate culpa.
        </p>
